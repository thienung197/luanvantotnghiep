...
@push('js')
    <script>
        ...
        $(".search-result").on("click", ".search-result-item", function() {
            ...
            quantityInput.style.width = "140px";
            ...
            unitPriceInput.style.width = "150px";
            ...
            discountInput.style.width = "150px";
            ...
            totalPriceInput.style.width = "150px";
